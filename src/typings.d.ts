...
export type readable_repository<T> 
    = sync_readable_repository<T> 
    | deferred_readable_repository<T> ;
export type repository<T> 
    = sync_repository<T> 
    | deferred_repository<T> ;
...
// --------------------------------------------------
//-- 
//-- export type readable_repository_nodep<T> 
//--     = sync_readable_repository_nodep<T> 
//--     | deferred_readable_repository_nodep<T> ;
//-- export type repository_nodep<T> 
//--     = sync_repository_nodep<T> 
//--     | deferred_repository_nodep<T> ;
//-- 
//-- 
//-- export interface ReadonlyBuffer_nodep<T> extends deferred_repository_nodep<T>{
//--     //------------------------------
//--     // CRUD
//--     //------------------------------
//--     fetch_sync(options:package_loc):resource_data<T>;
...
//-- }
//-- 
//-- export interface deferred_readable_repository_nodep<T> {
//-- 
...
//-- 
//-- 
//-- export interface deferred_repository_nodep<T> {
//-- 
//--     //------------------------------
//--     // CRUD
//--     //------------------------------
...
//-- }
//-- 
//-- export interface sync_readable_repository_nodep<T> {
//-- 
...
//-- }
//-- 
//-- export interface sync_repository_nodep<T> {
//-- 
//--     //------------------------------
//--     // CRUD
//--     //------------------------------
