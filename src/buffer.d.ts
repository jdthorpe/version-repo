...
import { package_loc, resource_data, deferred_readable_repository, readable_repository, fetch_opts, ConfigOptions } from "./typings";
export declare class ReadonlyBuffer<T> implements deferred_readable_repository<T> {
    remote_store: readable_repository<T>;
    versions_cache: {
        [x: string]: string[];
    };
    ...
    constructor(remote_store: readable_repository<T>, options?: ConfigOptions | MemoryRepo<T>);
