...
describe('Memory Repo', function() {
    ...
    it('POST(create) should create a library',function() {
        memory_repo.create({name:'foo',version:'v1.1.1'},
    ...
    it('POST(create) should not create a library twice',function() {
        expect(function(){memory_repo.create({name:'foo',version:'v1.1.1'},
                'My favorite equations')})
            .to.to.throw( Error,
    ...
    it('POST(create) should not create a previous version',function() {
        expect(function(){memory_repo.create({name:'foo',version:'v1.1.0'},
                'My favorite equations')})
            .to.throw( Error,
